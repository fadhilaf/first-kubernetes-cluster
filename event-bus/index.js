...
app.post("/events", (req, res) => {
  ...
  //link utk ke pod lainny kalo lewat cluster ip service, kito ganti jadi exact name of the service ny. (kubernetes lh buat domain di sistem internalny, jadi enak)
